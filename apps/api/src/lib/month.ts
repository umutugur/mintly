...
function parseMonth(value: string, fieldName: string): ParsedMonth {
...
export function getMonthBoundaries(month: string, fieldName: string): { start: Date; endExclusive: Date } {
