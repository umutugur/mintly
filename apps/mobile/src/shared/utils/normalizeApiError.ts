...
const API_CODE_TO_KEY: Record<string, string> = {
  ...
  TRANSFER_ACCOUNT_CONFLICT: 'errors.api.TRANSFER_ACCOUNT_CONFLICT',
  TRANSFER_CURRENCY_MISMATCH: 'errors.api.TRANSFER_CURRENCY_MISMATCH',
  ...
  ACCOUNT_CREATE_FAILED: 'errors.api.ACCOUNT_CREATE_FAILED',
  LOAN_SCHEDULE_CREATE_FAILED: 'errors.api.LOAN_SCHEDULE_CREATE_FAILED',
